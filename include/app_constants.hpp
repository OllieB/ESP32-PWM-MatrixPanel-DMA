...
#define ADDR_A_PIN              GPIO_NUM_16
#define ADDR_B_PIN              GPIO_NUM_17
#define ADDR_C_PIN              GPIO_NUM_6
#define ADDR_D_PIN              GPIO_NUM_42
#define ADDR_E_PIN              GPIO_NUM_5

#define MBI_GCLK                GPIO_NUM_15  // OE PIN IS GCLK apparently
#define MBI_LAT                 GPIO_NUM_18  //  data/command
#define MBI_DCLK                GPIO_NUM_7  // data clocking line?
#define MBI_SRCLK               GPIO_NUM_9   // I assume SR stands for Scan Row??  // When this is HIGH on these boards, output is disabled?

// First 1/4 of panel -> 20 rows
#define MBI_G1                  GPIO_NUM_4
#define MBI_B1                  GPIO_NUM_40 
#define MBI_R1                  GPIO_NUM_41 

// Second 1/4 of panel -> 20 rows
#define MBI_G2                  GPIO_NUM_14   
#define MBI_B2                  GPIO_NUM_45 
#define MBI_R2                  GPIO_NUM_39  

// Third 1/4 of panel -> 20 rows
#define MBI_G3                  GPIO_NUM_47  
#define MBI_B3                  GPIO_NUM_12 
#define MBI_R3                  GPIO_NUM_13 

// Forth 1/4 of panel -> 20 rows
#define MBI_G4                  GPIO_NUM_21    
#define MBI_B4                  GPIO_NUM_10 
#define MBI_R4                  GPIO_NUM_11
...
#define ghost_elimination_ON  0b11 // ghosting elimination disabled
#define ghost_elimination_OFF 0    // ghosting elimination enabled
#define gray_scale_13         1    // 13-bit grey scale
#define gray_scale_14         0    // 14-bit grey scale
...
// LED drive current / brightness, written to configuration register 1 bits [5:0] -> raw range 0-63
#define BRIGHTNESS_MIN          2   // LED current - MINIMUM (~1.4A)
#define BRIGHTNESS_LOW          5   // LED current - LOW (~1.75A)
#define BRIGHTNESS_MEDIUM       10  // LED current - MEDIUM (~2A) (default)
#define BRIGHTNESS_MEDIUM_HIGH  20  // LED current - MEDIUM HIGH (~3A)
#define BRIGHTNESS_HIGH         35  // LED current - HIGH (~5A)
#define BRIGHTNESS_MAX          63  // LED current - MAXIMUM (~12A) (Panel will get very hot at this setting, use with caution!)